<template>
  <div class="home">
    ...
    <section class="two-col-biometric-wrap text-white bio-all-content">
      <div class="container">
        <div class="row">
          <div class="col-12">
...
.about-content-wrapper .img-about-content {
  margin: auto;
  text-align: center;
  margin-top: -45px;
}
...
.contact-us-wrap::after {
  content: "";
  background-image: url("../assets/images/dotr.png");
